...
![Comando cd](https://cdn.hashnode.com/res/hashnode/image/upload/v1629665683655/qhvBHCWbq.png)
...
/>
  ...
  <Card 
    ...
    examples={[
      {
        description: 'Encontrar arquivos .txt, no diretório declarado',
        command: "find root_path -name '*.txt'"
      },
      {
        description: "Procurar apenas por diretórios",
        command: "find . -type d"
      }
    ]}
  />
...
<Slider>
  <div>
    ![curl -h calling](/assets/images/posts/curl-h.png)
  ...
  <div>
    ![mkdir -h calling](/assets/images/posts/mkdir-h.png)
