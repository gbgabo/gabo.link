...
<Slider>
  <div>
    <img class="showImage" src="https://cdn.hashnode.com/res/hashnode/image/upload/v1629856068335/GS4CzRHud.png" />
  </div>
  <div>
    <img class="showImage" src="https://cdn.hashnode.com/res/hashnode/image/upload/v1629860866026/IGjri2orv.png" />
    <p class="px-1">terminal shells</p>
  </div>
  <div>
    <img class="showImage" src="https://cdn.hashnode.com/res/hashnode/image/upload/v1629665683655/qhvBHCWbq.png" />
    <p class="px-1">ls command</p>
  </div>
  <div>
    <img class="showImage" src="https://cdn.hashnode.com/res/hashnode/image/upload/v1629674966105/4kky1z0-7.png" />
    <p class="px-1">TUI applications</p>
  </div>
</Slider>
